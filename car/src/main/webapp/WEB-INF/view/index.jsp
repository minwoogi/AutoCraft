            ...
            <div class="scrollable">
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-6">
                        <div id="com1000" class="card custom-card com" onclick="toggleCardBorder('com1000','.com')">
                            <!-- Product image-->
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div id="com1250" class="card custom-card com" onclick="toggleCardBorder('com1250','.com')">
                            <!-- Product image-->
