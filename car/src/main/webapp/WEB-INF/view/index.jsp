            ...
            <div class="scrollable">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="card">
                            <!-- Product image-->
                            <img class="card-img-top" src="img/displacement1000.png" alt="displacement1000"/>
                            <!-- Product details-->
                    ...
                    <div class="col-md-6">
                        <div class="card">
                            <!-- Product image-->
                            <img class="card-img-top" src="img/displacement1250.png" alt="displacement1000"/>
                            <!-- Product details-->
                            <div class="card-body p-4">
                                <div class="text-center">
                                    <!-- Product name-->
